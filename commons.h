...
#define AUDIO_VECTOR_SIZE 128 //64
...
#define UDP_BUFFER_SIZE 2057 //1033  // That is sizeof (Header) + sizeof (Token) + sizeof (TID) + sizeof (Size) + sizeof (AudioSample) * AUDIO_VECTOR_SIZE * NUM_CHANNELS...
