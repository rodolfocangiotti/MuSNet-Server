...
// #endif
  ...
  std::cout << "Comp. time: " << d * 1e-6 << " msecs. (avg: " << average(d) * 1e-6 << " - stddev: " << standard_deviation(d) * 1e-6 << ")\n";
  // std::this_thread::sleep_for(std::chrono::microseconds(420)); // Sleep time to reach 10Mbit/sec bandwidth...
  // XXX BRUTTA COSA, RALLENTA UN SACCO L'INVIO DEI PACCHETTI COSì...
  // DA RIVEDERE, PER IL MOMENTO COMMENTO...
}
